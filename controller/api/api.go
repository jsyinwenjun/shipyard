...
func (a *Api) Run() error {
	...
	apiRouter.HandleFunc("/api/servicereg", a.serviceRegs).Methods("GET")
	apiRouter.HandleFunc("/api/servicereg", a.saveServiceReg).Methods("POST")
	apiRouter.HandleFunc("/api/servicereg/{username}", a.serviceReg).Methods("GET")
	apiRouter.HandleFunc("/api/servicereg/{username}", a.deleteServiceReg).Methods("DELETE")
